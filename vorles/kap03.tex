...
mit \(\omega_{ni} =  \frac{E_n-E_i}{\hbar}\); \(f(\omega_{ni}) = 4\frac{sin^2\frac{\omega_{ni} t}{2}}{\omega^2_{ni}t}\)
...
Betrachte \(\frac{1}{E^2}sin^2 \frac{Et}{2\hbar} \stackrel{\mathrm{t\rightarrow \infty}}= c\delta(E)\)
