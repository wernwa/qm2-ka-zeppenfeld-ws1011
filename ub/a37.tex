...
Ersetze nun \(|n_\alpha\rangle^{(0)}\) mit der Summe der Entarteten untervektoren als \(|n_\alpha\rangle^{(0)} = \sum_\beta |\beta\rangle \). Der Index \(\beta\) läuft genau wie \(\alpha\) über alle entarteten Zustände
